...
function demo() {
    ...
    phy.load(['./assets/models/untitled.glb'], onComplete );
...
function onComplete(){
    ...
    const model = phy.getMesh('untitled')
...
*/        
    ...
    bob = phy.add({ 
        ...
        size:[ r,1.356-(2*r) ], pos:[0,3,0], angularFactor:[0,1,0], 
    ...
    //phy.add({ type:'box', name:'trigger', size:[4, 4, 4], pos:[0,-0.99,-3], material:'debug', mask:32 })
